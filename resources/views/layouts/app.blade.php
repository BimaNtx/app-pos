    ...
    <div class="h-screen flex overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="p-3 border-t border-teal-600/50 flex-shrink-0">
                <div class="flex items-center gap-3 px-4 py-3 text-teal-100 rounded-xl">
                    <div
                        class="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center text-white font-semibold flex-shrink-0">
                        {{ substr(Auth::user()->name ?? 'A', 0, 1) }}
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-white font-medium text-sm truncate">{{ Auth::user()->name ?? 'Guest' }}</p>
