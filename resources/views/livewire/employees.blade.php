                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-400 text-sm mt-1">Klik tombol "Tambah Karyawan" untuk menambahkan
                                        data baru</p>
                                </div>
                            </td>
                        </tr>
...
@push('scripts')
    <script>
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('employee-saved', (event) => {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
                    text: `Karyawan "${event[0].name}" berhasil ${event[0].type === 'created' ? 'ditambahkan' : 'diperbarui'}`,
                    timer: 2000,
            ...
            Livewire.on('employee-error', (event) => {
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal!',
            ...
            Livewire.on('password-reset', (event) => {
                Swal.fire({
                    icon: 'success',
                    title: 'Password Direset!',
                    text: `Password "${event[0].name}" berhasil direset ke "password123"`,
                    timer: 3000,
                    showConfirmButton: false
                });
            });
            ...
            Livewire.on('status-toggled', (event) => {
                Swal.fire({
                    icon: 'success',
                    title: 'Status Diubah!',
                    text: `Status "${event[0].name}" berhasil diubah menjadi ${event[0].status}`,
                    timer: 2000,
                    showConfirmButton: false
                });
            });
