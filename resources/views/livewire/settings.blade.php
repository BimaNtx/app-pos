            ...
            <div class="p-6 space-y-4">
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Bersihkan cache aplikasi</p>
                    </div>
                    <button type="button"
                ...
                <div class="flex items-center justify-between p-4 bg-red-50 rounded-xl">
                    <div>
                        <p class="font-medium text-red-800">Reset Semua Data</p>
                        <p class="text-red-600 text-sm">Ini akan menghapus semua transaksi dan produk</p>
                    </div>
                    <button type="button"
